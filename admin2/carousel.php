...
<div class="main-panel">
                  ...
                  <p class="card-description"> Add class <code>.table-striped</code>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <?php 
                            $sql="select * from bh_home_carousel";
                            $rs=$conn->query($sql);
                           //echo $rs->num_rows;
  ...
  ?>
                          <tr>
                            <td class="carousel">
                              <img src="<?php echo "files/".$row['carousel_img'];?>" alt="image"  width="150px" />
                            </td>
                           
                            <td><a href="carouseledit.php?cid=<?php echo $row['c_id'];?>">Edit</a></td>
