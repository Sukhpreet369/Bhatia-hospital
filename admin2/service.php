...
<div class="main-panel">
			<div class="content-wrapper pb-0">
				<div class="page-header flex-wrap">
				  ...
				  <div class="header-right d-flex flex-wrap mt-2 mt-sm-0">
					...
					<a  class="btn btn-primary mt-2 mt-sm-0 btn-icon-text" href="addserivce.php">
					  <i class="mdi mdi-plus-circle"></i> Add Services </a>
				  </div>
				</div>
                  ...
                  <p class="card-description"> Add class <code>.table-striped</code>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <?php 
                            $sql="select * from bh_home_services";
                            $rs=$conn->query($sql);
                           //echo $rs->num_rows;
  ...
  ?>
                          <tr>
							<td><?php echo $row['sertitl']; ?></td>
							<td><div class="dess"><?php echo $row['serdes']; ?></div></td>
							
							
                            <td><a href="upserivce.php?srid=<?php echo $row['srid'];?>">Edit</a></td>
							<td><a href="deleteservice.php?srid=<?php echo $row['srid'];?>">Delete</a></td>
                          </tr>
                          <?php }?>
