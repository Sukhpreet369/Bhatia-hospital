...
<div class="main-panel">
			<div class="content-wrapper pb-0">
				<div class="page-header flex-wrap">
				  ...
				  <div class="header-right d-flex flex-wrap mt-2 mt-sm-0">
					...
					<a  class="btn btn-primary mt-2 mt-sm-0 btn-icon-text" href="addwidgets.php">
					  <i class="mdi mdi-plus-circle"></i> Add widgets </a>
				  </div>
				</div>
  ...
  ?>
                          <tr>
                            ...
                            <td><?php echo $row['w_des'];?></td>
                            <td><a href="widgetedit.php?wid=<?php echo $row['w_id'];?>">Edit</a></td>
                            <td><a href="widgetdelete.php?wid=<?php echo $row['w_id'];?>">Delete</a></td>
                          </tr>
                          <?php 
                            }
                          ?>
