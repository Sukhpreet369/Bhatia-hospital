            ...
            <div class="page-header flex-wrap">
              ...
              <div class="header-right d-flex flex-wrap mt-2 mt-sm-0">
                ...
                <a  class="btn btn-primary mt-2 mt-sm-0 btn-icon-text" href="addlist.php">
                  <i class="mdi mdi-plus-circle"></i> Add New List</a>
              </div>
            </div>
<div class="col-lg-12 grid-margin stretch-card">
  ...
  ?>
                          <tr>
                            ...
                            <td>
                            <?php echo $row['list_detail'];?>
                            </td>
                            <td><a href="editlist.php?list_id=<?php echo $row['list_id'];?>">Edit</a></td>
                            <td><a href="deletelist.php?list_id=<?php echo $row['list_id'];?>">Delete</a></td>
                          </tr>
                          <?php }?>
