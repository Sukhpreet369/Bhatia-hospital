...
-->
  ...
  ?>
                          <tr>
                            <td class="slide">
                              <img src="<?php echo "files/".$row['imageUrl'];?>" alt="image"  width="150px" />
                            </td>
                           <!-- <td><?php echo $row['slide_title'];?></td>-->
                           <!-- <td>
                            <?php echo $row['slide_content'];?>
                            </td>
                            ...
                            <td><a href="slideedit.php?sid=<?php echo $row['sid'];?>">Edit</a></td>
                            <td><a href="slidedelete.php?sid=<?php echo $row['sid'];?>">Delete</a></td>
                          </tr>
                          <?php }?>
